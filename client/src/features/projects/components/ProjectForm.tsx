...
import { validateProjectForm } from '../projectsUtil'
import { useAppDispatch, useAppSelector, useFormikErrors } from '@/hooks'
import { createProject, toggleCreateProjectFormOpen } from '../projectsSlice'
...
export const ProjectFormWrapper = () => {
  ...
  const isFormOpen = useAppSelector(
    (state) => state.projects.projectForm.isOpen
  )

  const handleToggleProjectFormOpen = () => {
    dispatch(toggleCreateProjectFormOpen())
  }
